...
public partial class NorthWindContext : DbContext
{
    ...
    public virtual DbSet<VwCustOrderView> VwCustOrderViews { get; set; }

    public virtual DbSet<VwCustOrderView1> VwCustOrderView1s { get; set; }

    public virtual DbSet<VwOrderLineItem> VwOrderLineItems { get; set; }

    public virtual DbSet<VwOrderLineItems1> VwOrderLineItems1s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwCustOrderView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CustOrderView");
        ...
        modelBuilder.Entity<VwCustOrderView1>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CustOrderView1");
        ...
        modelBuilder.Entity<VwOrderLineItems1>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_OrderLineItems1");
